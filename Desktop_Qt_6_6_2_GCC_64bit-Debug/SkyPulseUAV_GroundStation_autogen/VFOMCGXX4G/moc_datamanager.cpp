...
#include "../../../SkyPulseUAV_GroundStation/TOOLS/datamanager.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSDataManagerENDCLASS_t qt_meta_stringdata_CLASSDataManagerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 19),  // "sig_fileMangerError"
        QT_MOC_LITERAL(32, 0),  // ""
        QT_MOC_LITERAL(33, 12)   // "ErrorMessage"
    },
    "DataManager",
    "sig_fileMangerError",
    "",
...
void DataManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sig_fileMangerError((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &DataManager::sig_fileMangerError; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DataManager::sig_fileMangerError(QString _t1)
{
