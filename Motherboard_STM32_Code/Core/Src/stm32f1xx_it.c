			...
			case PO_Falling:
			  {
				  ...
				  //Distance_Value[Distance_Num] = (Capture_Value2+Period_Num*65536-Capture_Value1) / 5.8;
				  //Distance_Num++;
				  //uint16_t value = Distance_Value[Distance_Num - 1];
				  Distance_Value = (Capture_Value2 + Period_Num * 65536 - Capture_Value1) / 5.88;
//				  if(Distance_Value > 4500)
//				  {
//					  Distance_Value = 4500;
//				  }
				  /* concatenate data and transmit to Raspberry Pi here.*/
